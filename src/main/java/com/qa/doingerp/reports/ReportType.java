...
{
  public abstract void createTestLogHeader(String paramString1, String paramString2, int paramInt1, int paramInt2);
  ...
  public abstract void createTestLogFooter(String paramString, int paramInt1, int paramInt2);

  public abstract void createResultSummaryFooter(String paramString, int paramInt1, int paramInt2);
}